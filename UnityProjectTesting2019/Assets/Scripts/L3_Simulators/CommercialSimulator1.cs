...
public class CommercialSimulator : IZoningSimulator, ILaborUnits {
    ...
    public int OccupantMax   => _empCtr.Max;        // Equivalent to _laborCtr.OccupantMax and required by IZonableBuilding

    // Bldg data getter; required by IZoningSimulator
